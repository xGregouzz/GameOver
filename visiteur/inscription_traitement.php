        ...
        if($row == 0){ 
            if($age > 18) { //On verifie que l'utilisateur est majeur
                if(strlen($nom) <= 100){ // On verifie que la longueur du nom <= 100
                    //if($interdiction_nom > 0){ //On verifie que le nom ne comporte pas de caracteres speciaux
                        if(strlen($prenom) <= 100){ // On verifie que la longueur du prenom <= 100
                            //if($interdiction_prenom > 0){ //On verifie que le prenom ne comporte pas de caracteres speciaux
