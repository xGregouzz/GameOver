...
<body>
    ...
    <div class="container">
        <center>
            <h3>Ajoutez l'article </h3>
            <h4>N'oubliez pas de remplir tous les champs</h4>
            <?php
                if (!empty($_POST)) {
                    include_once '../../Controleur/ajouter_article.php';
                }
            ?>
            <form method="post">
                <h4>Le nom :</h4>
                <textarea id="nom" name="nom" rows="1" cols="30" value=""></textarea>
                <h4>La plateforme :</h4>
                ...
                <textarea id="description" name="description" rows="11" cols="40" value=""></textarea>
                <h4>Le pegi :</h4>
