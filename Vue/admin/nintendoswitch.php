...
<body>
            ...
            <div class="topHeader">
                ...
                <section class="categorie">
                    <ul>
                        ...
                        <li><a href="Vue/admin/selectionner_commande.php">Modifier Commande</a></>
                        <li><a href="Vue/admin/selectionner_ligne_commande.php">Modifier Ligne Commande</a></li>
    ...
    <div class="container">
        <?php
            require_once('Modele/nintendoswitch.php');
